...
using static CameraController_Lvl03;

public class CameraController_Lvl03 : MonoBehaviour, ICameraController
{
    ...
    bool CanZoom()
    {
        return !isTransitioning && !GameManager_Lvl03.Instance.AreAnyPartsBeingPlaced();
    }
